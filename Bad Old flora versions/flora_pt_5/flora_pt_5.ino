...
void loop(void)
{
  ...
  if (counter > 300) { // every 300 cycles the thing resets. whill change depending on deelay. for this it'll be 30 sec of activity.
    counter = counter + 1;
  } else {
    counter = 0;
    greene = 0;
...
void colorChanger(float change) {
  ...
  /*if (counter > 70) {
    brightness = counter - 55;
    } else {brightness = counter;}
  strip.setBrightness(brightness);*/
